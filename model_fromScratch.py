###############################################################
'''This Python file trains a model from scratch to identify   # 
  the 10 different outfits in the Polyvore dataset.'''        #
                                                              #
...
if __name__=='__main__':
    ...
    #Saving the model
    model.save('model_fromscratch.hdf5')
    ...
    plt.title('Model')
    plt.legend()
    plt.savefig('learning_accuracy_fromScratch.png', dpi=256)
